...
User.create(name: 'Alastar')
User.create(name: 'Carbon')
...
Test.create(title: 'HTML & CSS Базовый', level: 1, category_id: 1)
Test.create(title: 'HTML & CSS Про', level: 2, category_id: 1)
Test.create(title: 'Javascript Базовый', level: 2, category_id: 2)
Test.create(title: 'Javascript Про', level: 3, category_id: 2)
Test.create(title: 'Ruby', level: 2, category_id: 3)
Test.create(title: 'Ruby On Rails', level: 4, category_id: 4)
